...
declare class BaiduTranslator extends Translator {
    /** 百度的语言类型映射不标准，需要手动控制 */
    private readonly Baidu_TRANSLATE_KEY_CONVERT_MAP;
    private getTranslateKey;
    constructor(option: BaiduTranslatorOption);
}

type index$1_BaiduTranslator = BaiduTranslator;
declare const index$1_BaiduTranslator: typeof BaiduTranslator;
type index$1_BaiduTranslatorOption = BaiduTranslatorOption;
...
export { BaiduTranslator, FunctionFactoryOption, GoogleTranslator, type OptionInfo, TranslateTypeEnum, Translator, type TranslatorOption, YoudaoTranslator, base as baseUtils, checkOption, file as fileUtils, index as filter, initOption, option, translate as translateUtils, index$1 as translator };
